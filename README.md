...
* **/Actividad 2**: Gestion billete de  Metro.
...
* **Actividades**: Modela la lógica de pago. Se diferencia el proceso entre el uso de tarjeta y efectivo
* **Estados**: Detalla el ciclo de vida de un billete, transitando por estados como "Emitido", "Validado" y "Agotado" o "Caducado".

### Actividad 3: Sistema de Control de una Alarma Inteligente
* **Estados**: Refleja el comportamiento del sistema. Destaca el estado "En Espera"  y el acceso global al estado de "Mantenimiento".
...
* **Transiciones de Estado**: Se han definido eventos claros (introducir código, detectar movimiento, picar billete) .
